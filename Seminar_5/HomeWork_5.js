...
// const havePhoto = products.filter(photo => photo.photos && photo.photos.length !== 0);
// console.log(havePhoto);

// const minSorted = products.sort((a, b) => a.price > b.price ? 1 : -1);
// console.log(products);
...
//     console.log("Нет возможности объединить массивы");
// }
